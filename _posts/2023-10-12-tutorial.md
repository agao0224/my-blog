...
<strong> Python code Input >>> </strong> <br>
Dictionary_example = { <br>
                'Point Guard' : 'Stephen Curry', 'Damian Lillard' <br>
                'Shooting Guard' : 'Devin Booker', 'Anthony Edwards' <br>
                'Small Forward' : 'LeBron James', 'Jayson Tatum'<br>
                'Power Forward' : 'Kevin Durant',  'Anthony Davis'<br>
                'Center' : 'Bam Adebayo' <br>
}
<br>
